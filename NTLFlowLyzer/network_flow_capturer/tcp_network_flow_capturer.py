                ...
                try:
                    ...
                    while decapsulation:
                        ...
                        if (
                            ...
                            if not (
                                (socket.inet_ntoa(ip.src) == self.__vxlan_ip and socket.inet_ntoa(ip.dst)[0:5] == "10.0.")
                                or (socket.inet_ntoa(ip.dst) == self.__vxlan_ip and socket.inet_ntoa(ip.src)[0:5] == "10.0.")
                            ):
                                decapsulation = False
                                break
